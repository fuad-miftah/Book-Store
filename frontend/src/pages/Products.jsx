...
export default function Products() {
  ...
  const filteredData = data.filter((book) => {
    ...
    // Check if the search term is present in the book title or other relevant properties
    const isSearchMatch =
      searchTerm === "" ||
  ...
  return (
    <div>
      ...
      <div className="mb-4 left-[104px] items-end justify-center relative border-spacing-1">
        <input  className="lg:w-[450px] h-[48px] md:w-auto bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-700 focus:border-green-700 pl-8 pr-0"
          type="text"
      ...
      {data ? (
        <div className="flex flex-col md:flex-row items-start justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 bg-white rounded-lg gap-4 items-center justify-center md:items-start md:gap-16 space-y-2">
